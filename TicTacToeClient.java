...
public class TicTacToeClient {
    ...
    private JFrame frame = new JFrame("Tic Tac Toe");// create the tic tac Frame
    ...
    public void play() throws Exception {
        String response;
        String xGif="/class 2018/Parallel/x.png";
        String oGif="/class 2018/Parallel/o.png";
        try {
            response = in.readLine();
            if (response.startsWith("WELCOME")) {
                char mark = response.charAt(8);
                icon = new ImageIcon(mark == 'X' ? xGif : oGif);
                opponentIcon  = new ImageIcon(mark == 'X' ? xGif : oGif);
